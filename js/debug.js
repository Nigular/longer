...
window.alert = function() {
	...
	longer.debug.p.innerHTML = str.substr(0, str.length - 1);
}
document.addEventListener('DOMContentLoaded', function(e) {
	longer.debug.p.style.cssText = 'width: 100%;font-size:0.24rem;line-height: 1.2;font-weight: bold;position:absolute;z-index:10086;top:1em;left:0;word-break:break-all;pointer-events: none;background-color: rgba(0,0,0,0.2);color: white;padding: 0;margin: 0;';
	document.body.appendChild(longer.debug.p);
}, false);
